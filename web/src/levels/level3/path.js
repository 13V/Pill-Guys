...
export default {
  ...
  decks: [
    ...
    { kind: 'platform', cx: 10, cz: 0, w: 4, d: 4 },                       // B gap landing    x: 8..12  (gap 2)
    { kind: 'platform', cx: 16, cz: 0, w: 4, d: 4 },                       // C gap landing    x:14..18  (gap 2)
    ...
    { kind: 'platform', cx: 38, cz: 0, w: 4, d: 4 },                       // F post-conveyor  x:36..40  (gap 2, push helps)
    ...
    { kind: 'platform', cx: 52, cz: 0, w: 4, d: 4 },                       // I drop landing   x:50..54  (drop -3; spring#2 here)
