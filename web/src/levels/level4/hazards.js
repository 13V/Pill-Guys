...
// - BRANCH 1 RISKY (z+3): a size-4 SPIKE GAUNTLET (cx18; spike box x16..20) over the
//   4u void between the solid run-up (x13..16) and the long boost belt (x20..51).
//   JUMP from the run-up over the spikes and land on the belt, then ride it GROUNDED.
// - BRANCH 2 RISKY (z+3): a 4u belt-assisted JUMP-GAP (x67..71) with a LETHAL sawblade
//   IN the pit (cx69) — the same leap (off the run-up belt) that clears the gap clears
