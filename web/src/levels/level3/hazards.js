...
export const hazards = [
  ...
  { kind: 'sawblade', cx: 22, cz: 0 },                      // decorative menace on hub D (NO lethal flag => no death sensor)
  ...
  { kind: 'cone', cx: 35, cz: 1.6 },                        // warn: gap after the conveyor
  { kind: 'cone', cx: 35, cz: -1.6 },
];
export const springs = [
  { cx: 43, cz: 0 },                                        // spring #1: pad G (top5) -> raised hub H (top8)
  { cx: 53, cz: 0 },                                        // spring #2: deck I (top5) -> finish tower (top10)
];
